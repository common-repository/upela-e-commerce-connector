...
class User
{
	protected $username_upela;
	protected $password_upela;
	...
	public function __construct()
    {
        ...
        $this->username_upela = $user['username_upela'];
        $this->password_upela = $user['password_upela'];
	...
	public function getUsername() {
		return $this->username_upela;
	}
	
	public function getPassword() {
		return $this->password_upela;
	}
	...
	public function setCredentials($name,$password) {
		...
		$this->username_upela = $name;
        $this->password_upela = $password;
		$wpdb->update( $table, 
				array( 
						'username_upela' => $name, 
		 				'password_upela' => $password
					), 
				array( 'id' => 1 )
		);
	}
